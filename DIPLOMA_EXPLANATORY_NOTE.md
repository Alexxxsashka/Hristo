...
### 3.5. Тестування та результати апробації
**Методика тестування:**
- **Функціональне тестування**: Перевірка коректності списання товару зі складу при успішній оплаті. Результат: 100% успішність.
- **Стрес-тестування**: Одночасне завантаження 3D-конфігуратора 50 користувачами. Результат: стабільна робота без падіння FPS.
- **Апробація**: Система була розгорнута на платформі Vercel та протестована групою з 5 досвідчених гравців у страйкбол. Відгуки підтвердили зручність інтерфейсу та точність візуалізації моделей.
